...
function Friend({friend, onSelection, selectedFriend}) {
  ...
  <li className={isSelected ? "selected" : ""} >
    ...
    {friend.balance > 0 && <p className="green">{friend.name} owe {Math.abs(friend.balance)}₹ to you</p>}
    {friend.balance === 0 && <p className="">you and your friend {friend.name} are even with {Math.abs(friend.balance)}₹</p>}
